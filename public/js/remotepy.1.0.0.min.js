  ...
  (this.serverName = void 0 === e ? "ws://localhost:8082" : e),
    ...
    (this.callMultipleCallbackPythonFunction = function (e, ...i) {
      ...
      (e = n[0]),
        ...
        callbacks.length > 0 &&
          this.registerMultipleCallbackPythonFunction(e, ...callbacks);
    }),
    ...
    (this.callFunc = function (e, i, n) {
      this.isOpen
        ? (this.socket.send(
          ...
          console.log(
            "Function : " + e + " called with arguments: " + JSON.stringify(i)
          ))
        : console.log("Connection not open."),
    ...
    (this.callPythonFunctionBinary = function (e, i, n, t) {
      void 0 === i && (i = {}),
        ...
        this.isOpen
          ? (this.sendBinary(n),
            void 0 === t || this.registerCallbackToPythonFunction(e, t))
          : console.log("Connection not open.");
    }),
    ...
    (this.sendNonImageBinary = function (e) {
      if (e.type.match(/image.*/))
        console.log("The dropped file is an image: ", e.type);
      else {
        var i = new FileReader();
        (i.onload = function (e) {
          var i = e.target.result;
    ...
    (this.createJSProxyFunctions = function (e) {
      for (var i in this.PythonFunctionsArgs) {
        ...
        if ((n.push(t), (JS2PySelf = this), i.indexOf(".") >= 0)) {
          for (
            var r = i.split("."), o = this.PythonFunctions, s = 0;
            s < r.length - 1;
            s++
          )
    ...
    (this.start = function () {
      ...
      console.log("Connecting to : " + e + " ..."),
        ...
        (this.socket.onmessage = function (e) {
          if (
            (void 0 !== JS2PySelf.onmessagereceived &&
            ...
            if ("args" in i) {
              ...
              switch (
                (t = JS2PySelf.pythonMultipleCallbackDict[i.funcName]).length
              ) {
                case 0:
                  break;
                case 1:
                ...
                case 2:
                  "error" in i && t[0](i.error, !1),
                    "return" in i && t[0](i.streaming, i.return, !1),
                    "row" == i.streaming &&
                      t[1](i.stream_index, i.stream_item, !1);
                  break;
                case 3:
                  "error" in i && t[0](i.error, !1),
              ...
              switch (
                ...
                case 1:
                  "error" in i && t[0](i.error, !1),
                    "return" in i && t[0](i.return, !1);
                  break;
                case 2:
                  "error" in i && t[1](i.error, !1),
                    "return" in i && t[0](i.return, !1);
                  break;
                case 3:
                  "error" in i && t[0](i.error, !1),
            ...
            for (
              var o = new Uint8Array(e.data), s = " ", a = 0;
              a < o.length;
              a++
            )
          ...
          void 0 !== JS2PySelf.onmessageprocessed &&
