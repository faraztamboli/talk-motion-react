class camcorder {
    constructor(id_camera_video, recording, player, open_recording_shot, close_recording_shot) {
    ...
    async recordStream() {
        ...
        */
        ...
        this.recorder.onresume = () => {
            ...
            let shot = new recording_shot(session_id, original_video_start, recording_start, js_start);
            ...
            this.open_recording_shot(current_recording.recording_id, original_video_start, recording_start, js_start);
        };
        ...
        function record_blob_base64(me, original_video_end, js_end) {
            ...
            reader.onloadend = function() {
              ...
              // TODO: write to server here
                ...
                rshot.close(shot, blob_url, chunk_size, original_video_end, recording_end, js_end);
                ...
                let video_recording_shot_id = current_recording.get_active_shot().recording_shot_id;
                let active_parts = null;
                me.close_recording_shot(video_recording_shot_id, chunk_size, original_video_end, recording_end, js_end, shot, active_parts);
                console.log(rshot);
            }
        }
