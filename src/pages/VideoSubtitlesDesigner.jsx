...
import { Card, Col, Input, Row, Tabs, Typography, Steps, Space, Button, Collapse } from "antd";
const { TextArea } = Input;
import { LinkOutlined, SearchOutlined, PlayCircleOutlined, VideoCameraOutlined, EditOutlined, ThunderboltOutlined, RobotOutlined } from "@ant-design/icons";
          ...
          <Space direction="vertical" size="large" style={{ width: '100%' }}>
            ...
            <div style={{ textAlign: 'center', padding: '16px', background: '#f5f5f5', borderRadius: '8px' }}>
              <Text strong style={{ display: 'block', marginBottom: '12px', fontSize: '16px' }}>
                Click the record button to enable/disable recording
              </Text>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px' }}>
                ...
                <button 
                  ...
                  title="Click to enable/disable recording. Recording starts automatically when video plays."
              ...
              <Text type="secondary" style={{ display: 'block', marginTop: '8px', fontSize: '12px' }}>
                Red button = Recording enabled (starts when video plays) | Gray button = Recording disabled
              </Text>
            </div>
              ...
              items={[
                {
                  ...
                  label: (
                    <Space>
                      ...
                      <Text type="secondary" style={{ fontSize: '12px' }}>
                        Generate descriptions and summaries with AI
                      </Text>
                    </Space>
                  ),
                  children: (
                      ...
                      <Col xs={24} md={12}>
                        <AIContentGenerator
                          ...
                          onContentApproved={(content) => {
                            ...
                            if (recordingId) {
                              updateRecordingTitleAndDescription(title, content);
                            }
                          }}
                        />
                      </Col>
